...
<head>
    ...
    <title>Catálogo | No a la violencia intrafamiliar</title>
...
<body>
    <header id="cabecera">
        ...
        <h1 class="logo"> <a href="index.html" > No a la violencia intrafamiliar </a></h1>
        <img src="imgagenes/menu.png" class="icon-menu" id="boton-menu">
        <nav>
            <ul>
